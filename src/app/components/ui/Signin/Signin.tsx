  ...
  return (
    <>
     <Link href="/auth/signin">
      <Button  variant='outline' border='1px solid black' ml="10px">Sign in</Button>
    </Link>
         ...
         <Flex>
          <Flex direction="column" width="45%" gap='16px' alignItems='center'>
            <Flex direction="column" alignItems="center" mb='20px'>
              <Text fontSize="32px" fontWeight="500">Log in to your account</Text>
              <Text>Don&apos;t have an account?<Text as="span" textDecor="underline">Sign up</Text></Text>
            </Flex>
          ...
          <Flex direction="column" width="55%" alignItems='center' justifyContent='center' gap='10px'>
            ...
            <Button width="100%" height="64px" mt='40px'>Login</Button>
          </Flex>
         </Flex>
        </ModalBody>
